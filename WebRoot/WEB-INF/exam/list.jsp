					...
					<tbody>
						<c:forEach var="exam" items="${pageinfo.resultList}" varStatus="vstatus">
							<tr>
								...
								<td>${exam.score4}</td>
								<td>
									<a href="javascript:;" onclick="url('${pageContext.request.contextPath}/exam/addOrUpdate?id=${exam.id}')" class="edit" >录入成绩</a>
									<a href="javascript:" class="delete" data-id="${exam.id}" >删除</a>
								</td>
							</tr>
						</c:forEach>
					</tbody>
