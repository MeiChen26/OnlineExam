				...
				$.ajax({
					...
					success:function(data){
						if(data.code == "000") {//请求成功
							...
							if(exam != null && exam != '') {
								$("#id").val(exam.id);
								if(exam.score1 != null && exam.score1 != '') {
									...
									if(exam.score2 != null && exam.score2 != '') {
										$("#table").find("tbody").append('<tr class="score">\
										...
										if(exam.score3 != null && exam.score3 != '') {
											$("#table").find("tbody").append('<tr class="score">\
											...
											if(exam.score4 != null && exam.score4 != '') {
												$("#table").find("tbody").append('<tr class="score">\
												...
												if(parentInt(exam.score3) > 79) { //科三成绩>=80时，才可以录入科四
													$("#table").find("tbody").append('<tr class="score">\
															<th class="first minw120">科目四成绩</th>\
															<th class="second maxw300">\
																<div class="text-input">\
																	<input type="text" name="score4" id="score4" value="" maxlength="20"\
											...
											if(parentInt(exam.score2) > 79) { //科二成绩>=80时，才可以录入科三
												$("#table").find("tbody").append('<tr class="score">\
														<th class="first minw120">科目三成绩</th>\
														<th class="second maxw300">\
															<div class="text-input">\
																<input type="text" name="score3" id="score3" value="" maxlength="20"\
										...
										if(parentInt(exam.score1) > 89) { //科一成绩>=90时，才可以录入科二
											$("#table").find("tbody").append('<tr class="score">\
													<th class="first minw120">科目二成绩</th>\
													<th class="second maxw300">\
														<div class="text-input">\
															<input type="text" name="score2" id="score2" value="" maxlength="20"\
